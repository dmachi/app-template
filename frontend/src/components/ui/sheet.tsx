...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-white p-4 shadow-lg transition ease-in-out dark:bg-slate-950",
  {
    variants: {
      side: {
        top: "inset-x-0 top-0 border-b border-slate-200 dark:border-slate-800",
        bottom: "inset-x-0 bottom-0 border-t border-slate-200 dark:border-slate-800",
        left: "inset-y-0 left-0 h-full w-3/4 border-r border-slate-200 dark:border-slate-800 sm:max-w-sm",
        right: "inset-y-0 right-0 h-full w-3/4 border-l border-slate-200 dark:border-slate-800 sm:max-w-sm",
      },
    },
    defaultVariants: {
      side: "right",
